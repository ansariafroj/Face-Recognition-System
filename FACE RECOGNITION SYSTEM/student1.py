...
class Student:
    def __init__(self, root):
        ...
        # first image
        img = Image.open(r"C:\Users\Afroj Ansari\OneDrive\Desktop\college_images\face-recognition.png")
        ...
        # second image
        img1= Image.open(r"C:\Users\Afroj Ansari\OneDrive\Desktop\college_images\smart-attendance.jpg")
        ...
        # third image
        img2 = Image.open(r"C:\Users\Afroj Ansari\OneDrive\Desktop\college_images\iStock.jpg")
        ...
        # Left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",fg="red",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        ...
        current_course_frame.place(x=2.5,y=135,width=720,height=115)
        ...
        dep_combo["values"]=("Select Department","CSE","CSE-CS","Civil","Mechanical","AI&DS","BME")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course","BE","B.Tech","SAS","FAHS","AVIL")
        ...
        class_Student_frame.place(x=2.5,y=250,width=720,height=300)
        ...
        img_right = Image.open(r"C:\Users\Afroj Ansari\OneDrive\Desktop\college_images\student.jpg")
        img_right = img_right.resize((709,130),Image.AFFINE)
        self.photoimg_right = ImageTk.PhotoImage(img_right)

        f_lbl=Label(Right_frame,image=self.photoimg_right)
        f_lbl.place(x=3.5, y=0,width=709,height=130)

        #========Search System==========
        Search_frame=LabelFrame(Right_frame,bd=2,bg="white",fg="darkgreen",relief=RIDGE,text="Search System",font=("times new roman",12,"bold"))
        Search_frame.place(x=2.5,y=135,width=710,height=70)
        ...
        table_frame.place(x=2.5,y=210,width=710,height=350)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="Afroj@2000",database="face_reconiser_syatem")
    ...
    def generate_dataset(self):
         if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                 ...
                 # Inside the for loop where you are updating student records
                 id = 0
                 for x in myresult:
                    id += 1
                    self.var_std_id.set(str(id))  # Set the student ID for the current record
                    my_cursor.execute("update student set Dep=%s, course=%s, Year=%s, Semester=%s, Name=%s, Division=%s, Roll=%s, Gender=%s, Dob=%s, Email=%s, Phone=%s, Address=%s, Teacher=%s, PhotoSample=%s where Student_id=%s", (
                                                              self.var_dep.get(),
                                                              self.var_course.get(),
                                                              self.var_year.get(),
                    ...
                    #face_cascade=cv2.CascadeClassifier(r"C:\Program Files\Python312\Lib\cv2\data\haarcascade_frontalface_default.xml")
                    ...
                    while True:
                       ...
                       file_name_path = "C:\\Users\\Afroj Ansari\\OneDrive\\Desktop\\Python\\FACE RECOGNITION SYSTEM\\data\\user." + str(id) + "." + str(img_id) + ".jpg"  # Use img_id instead of id
                       cv2.imwrite(file_name_path, face)
                       cv2.putText(face, str(img_id), (50, 50), cv2.FONT_HERSHEY_COMPLEX, 2, (0, 255, 0), 2)
                       cv2.imshow("Detect Faces", face)
                       #cv2.imshow("Face Cropped",face_cropped)
                       #cv2.imshow("Cropped Face",face)
                       key=cv2.waitKey(1)

                       if key == 13 or int(img_id) == 10:
                        break
